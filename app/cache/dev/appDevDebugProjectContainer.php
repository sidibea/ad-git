...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'next-bus.net', 'port' => 3306, 'dbname' => 'nextb9og_voyage', 'user' => 'nextb9og_fatou', 'password' => 'sorofing', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4dc0769997e0dd92493eaf9a71507428574a5a6803823e95c947af3039b875f0');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '2c143d9251ebdc25707b99fc61c62f8036f6d114', 'main', array('lifetime' => 3650000, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '2c143d9251ebdc25707b99fc61c62f8036f6d114', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58b2fae926d3e0.35774662')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => 'next-bus.net',
            'logo_directory' => ($this->targetDirs[2].'/../web/assets/images/uploads/compagnies/logo/'),
            'photo_directory' => ($this->targetDirs[2].'/../web/assets/images/uploads/compagnies/photo/'),
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'next-bus.net',
