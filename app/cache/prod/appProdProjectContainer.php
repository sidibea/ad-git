...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'next-bus.net', 'port' => 3306, 'dbname' => 'nextb9og_voyage', 'user' => 'nextb9og_fatou', 'password' => 'sorofing', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0f685ab114825833e9e70d540b6e4c5fa7831fcdb57611c148461d2ca4094a15');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'logo_directory' => ($this->targetDirs[2].'/../web/assets/images/uploads'),
            'photo_directory' => ($this->targetDirs[2].'/../web/assets/images/uploads'),
